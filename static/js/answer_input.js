...
$(document).ready(function () {
    ...
    if (String(template_type) == 'multiple') {
        ...
        for (var i = 0; i < choices.length; i++) {
            text = choices[i];
            w_target.append('<div class="col-md-12"><input type="radio" name="answer_button" id="radio' + i + '" value="' + choices[i] + '"/><span input_mathquill class="mathquill-embedded-latex">' + text + '</span></div>');
        }
    }
