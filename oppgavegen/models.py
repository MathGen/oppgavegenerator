...
class Template(models.Model):
    ...
    creator = models.ForeignKey(User, blank=True)             #User ID of creator of template
    ...
    rating = models.PositiveSmallIntegerField(blank=True)     #Difficulty rating. Defaults to 1200.
    times_solved = models.PositiveIntegerField(blank=True)    #Amount of times the problem has been solved.
    times_failed = models.PositiveIntegerField(blank=True)    #Amount of times the problem has not been solved (wrong answer.)
    ...
    number_of_answers = models.SmallIntegerField(blank=True)  #The number of answers to to questions. (i.e. Second-degree polynomial equations may have 2 solutions
