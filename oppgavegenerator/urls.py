...
urlpatterns = patterns('',
    ...
    url(r'^chapter/(\d+)/chapter/(\d+)/add_level/$', add_level_to_chapter, name='add_level_to_chapter'),
    url(r'^chapter/(\d+)/chapter/(\d+)/remove_level/$', remove_level_from_chapter, name='remove_level_from_chapter'),
    url(r'^level/(\d+)/template/(\d+)/add_template/$', add_template_to_level, name='new_chapter_for_set'),
    url(r'^level/(\d+)/template/(\d+)/remove_template/$', remove_template_from_level, name='remove_template_from_level'),
    # DJANGO SELECTABLE
